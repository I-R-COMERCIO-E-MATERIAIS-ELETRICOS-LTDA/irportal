...
function toggleCalendar() {
    ...
    else { calendarYear = currentMonth.getFullYear(); renderCalendar(); modal.classList.add('show'); }
}

function changeCalendarYear(direction) { calendarYear += direction; renderCalendar(); }
...
function renderCalendar() {
    ...
    monthNames.forEach((name, index) => {
        ...
        if (calendarYear === currentMonth.getFullYear() && index === currentMonth.getMonth()) monthButton.classList.add('current');
