...
// ============================================
// CONEXÃO E STATUS (sem indicador visual)
// ============================================
...
// ============================================
// MODAL DE CONFIMAÇÃO GENÉRICO (para reverter pagamento)
// ============================================
    ...
    const modalHTML = `
        <div class="modal-overlay" id="customDeleteModal" style="display: flex !important; z-index: 10001 !important;">
            <div class="modal-content confirm-modal-content" style="max-width: 450px !important;">
                ...
                <div class="modal-actions confirm-modal-actions">
                    <button class="danger" id="customDeleteConfirmBtn">Sim</button>
                    <button class="success" id="customDeleteCancelBtn">Cancelar</button>
                </div>
            </div>
        </div>`;
    document.body.insertAdjacentHTML('beforeend', modalHTML);
    ...
    const modalHTML = `
        <div class="modal-overlay" id="confirmPagModal" style="display: flex !important; z-index: 10001 !important;">
            <div class="modal-content confirm-modal-content" style="max-width: 450px !important;">
                ...
                <div class="modal-actions confirm-modal-actions">
                    <button class="save" id="btnSim">Sim</button>
        ...
        <div class="modal-overlay show" id="viewModal">
            <div class="modal-content">
                ...
                <div class="modal-actions">
                    ...
                    <button type="button" class="cancel-close" onclick="document.getElementById('viewModal').remove()">Fechar</button>
                </div>
            </div>
        </div>`;
...
// ============================================
// MODAL DE FORMULÁRIO (por abas, botões ajustados)
// ============================================
        ...
        <div class="modal-overlay show" id="formModal">
            <div class="modal-content">
                ...
                <div class="modal-actions">
                    ...
                    <button type="button" class="cancel-close" onclick="closeFormModal()">Cancelar</button>
                </div>
            </div>
        </div>`;
