...
// ─── GET /api/lucro-real ─────────────────────────────────────────────────────
// ?mes=N&ano=N  → filtra por mês/ano
// ?ano=N        → retorna todos os meses do ano (relatório anual)
...
// ─── GET /api/custo-fixo ─────────────────────────────────────────────────────
// Retorna custo_fixo_mensal de qualquer registro do mês (todos têm o mesmo valor)
...
// ─── POST /api/custo-fixo ────────────────────────────────────────────────────
// Atualiza custo_fixo_mensal em TODOS os registros do mês informado
...
// Endpoint de sync/monitoramento — mantido para compatibilidade com o frontend
router.post('/monitorar-pedidos', async (req, res) => {
    // Este endpoint era usado pelo frontend antigo como "heartbeat".
    // No monorepo centralizado, serve apenas para confirmar conectividade.
    res.json({ ok: true });
});
